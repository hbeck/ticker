...
/**
  ...
  */
case class ReactiveEvaluationEngine(program: TransformedLarsProgram, tmsPolicy: TmsPolicy) extends EvaluationEngine {


  val (groundRules, nonGroundRules) = program.rules partition (_.isGround)
