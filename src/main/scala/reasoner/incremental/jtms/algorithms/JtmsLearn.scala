...
import reasoner.incremental.jtms.IncrementalUpdateFailureException
import reasoner.incremental.jtms.networks.{IncrementalHashCode, OptimizedNetworkForLearn}
