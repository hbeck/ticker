...
class NameForSpec extends TransformLarsSpec {
  ...
  "The name for window-atom w_#^1 d b" should "be w_tu_2_d_b" in{
    ...
    assert(LarsToPinnedProgram.nameFor(window) == "w_tu_2_d_b")
  }
}
