...
/**
  ...
  * scale: nr of nodes
  */
case class ReachLtInstance(random: Random, wm: String, windowSize: Int, signalEvery: Int, scale: Int) extends Instance with LinReachLtProgramProvider with RandomProvider {
